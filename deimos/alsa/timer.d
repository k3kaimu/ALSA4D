...
ptrdiff_t snd_timer_read(snd_timer_t *handle, void *buffer, size_t size);
...
size_t snd_timer_ginfo_get_resolution(snd_timer_ginfo_t *obj);
size_t snd_timer_ginfo_get_resolution_min(snd_timer_ginfo_t *obj);
size_t snd_timer_ginfo_get_resolution_max(snd_timer_ginfo_t *obj);
...
ptrdiff_t snd_timer_info_get_resolution(snd_timer_info_t * info);
...
void snd_timer_params_set_ticks(snd_timer_params_t * params, ptrdiff_t ticks);
ptrdiff_t snd_timer_params_get_ticks(snd_timer_params_t * params);
void snd_timer_params_set_queue_size(snd_timer_params_t * params, ptrdiff_t queue_size);
ptrdiff_t snd_timer_params_get_queue_size(snd_timer_params_t * params);
...
ptrdiff_t snd_timer_status_get_resolution(snd_timer_status_t * status);
ptrdiff_t snd_timer_status_get_lost(snd_timer_status_t * status);
ptrdiff_t snd_timer_status_get_overrun(snd_timer_status_t * status);
ptrdiff_t snd_timer_status_get_queue(snd_timer_status_t * status);

/* deprecated functions, for compatibility */
ptrdiff_t snd_timer_info_get_ticks(snd_timer_info_t * info);
