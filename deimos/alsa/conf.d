...
//alias SND_CONFIG_DLSYM_VERSION_EVALUATE	_dlsym_config_evaluate_001;
/** \brief \c dlsym version for the config hook callback. */
//alias SND_CONFIG_DLSYM_VERSION_HOOK		_dlsym_config_hook_001;
...
int snd_config_imake_integer(snd_config_t** config, const(char)* key, const ptrdiff_t value);
...
int snd_config_set_integer(snd_config_t* config, ptrdiff_t value);
int snd_config_set_integer64(snd_config_t* config, long value);
int snd_config_set_real(snd_config_t* config, double value);
int snd_config_set_string(snd_config_t* config, const(char)* value);
int snd_config_set_ascii(snd_config_t* config, const(char)* ascii);
int snd_config_set_pointer(snd_config_t* config, const(void)* ptr_);
int snd_config_get_id(const(snd_config_t)* config, const(char)** value);
int snd_config_get_integer(const(snd_config_t)* config, ptrdiff_t* value);
