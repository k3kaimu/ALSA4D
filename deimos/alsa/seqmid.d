 ...
 */
alias snd_seq_ev_set_tag = id!((ev, t) => 
    ((ev).tag = (t)));
 ...
 */
alias snd_seq_ev_set_dest = id!((ev, c, p) => 
 ...
 */
alias snd_seq_ev_set_subs = id!((ev) => 
 ...
 * \sa snd_seq_ev_set_dest()
 */
alias snd_seq_ev_set_broadcast = id!((ev) => 
 ...
 */
alias snd_seq_ev_set_source = id !((ev, p) => 
    ((ev).source.port = (p)));
 ...
 */
alias snd_seq_ev_set_direct = id!((ev) => 
 ...
 */
alias snd_seq_ev_schedule_tick = id!((ev, q, relative, ttick) =>
 ...
 */
alias snd_seq_ev_schedule_real = id!((ev, q, relative, rtime) => 
    ((ev).flags &= ~(SND_SEQ_TIME_STAMP_MASK | SND_SEQ_TIME_MODE_MASK),
 ...
 */
alias snd_seq_ev_set_priority = id !((ev, high_prior) =>
 ...
 */
alias snd_seq_ev_set_fixed = id!((ev) =>
 ...
 */
alias snd_seq_ev_set_variable = id!((ev, datalen, dataptr) => 
    ((ev).flags &= ~SND_SEQ_EVENT_LENGTH_MASK,
 ...
 */
alias snd_seq_ev_set_varusr = id!((ev, datalen, dataptr) =>
    ((ev).flags &= ~SND_SEQ_EVENT_LENGTH_MASK,
 ...
 */
alias snd_seq_ev_set_queue_control = id!((ev, typ, q, val) =>
    ((ev).type = (typ),
 ...
 */
alias snd_seq_ev_set_queue_start = id!((ev, q) =>
 ...
 */
alias snd_seq_ev_set_queue_stop = id!((ev, q) =>
 ...
 */
alias snd_seq_ev_set_queue_continue = id!((ev, q) =>
 ...
 */
alias snd_seq_ev_set_queue_tempo = id!((ev, q, val) =>
 ...
 */
alias snd_seq_ev_set_queue_pos_real = id!((ev, q, rtime) =>
 ...
 */
alias snd_seq_ev_set_queue_pos_tick = id!((ev, q, ttime) =>
 ...
 */
alias snd_seq_start_queue = id!((seq, q, ev) =>
 ...
 * \param ev optional event record (see #snd_seq_control_queue)
 */
alias snd_seq_stop_queue = id!((seq, q, ev) =>
 ...
 * \param ev optional event record (see #snd_seq_control_queue)
 */
alias snd_seq_continue_queue = id!((seq, q, ev) =>
 ...
 * \param ev optional event record (see #snd_seq_control_queue)
 */
alias snd_seq_change_queue_tempo = id!((seq, q, tempo, ev) =>
 ...
 */
alias snd_seq_ev_set_note = id!((ev, ch, key, vel, dur) =>
 ...
 * \param vel velocity
 */
alias snd_seq_ev_set_noteon = id!((ev, ch, key, vel) =>
 ...
 * \param vel velocity
 */
alias snd_seq_ev_set_noteoff = id!((ev, ch, key, vel) =>
 ...
 * \param vel velocity
 */
alias snd_seq_ev_set_keypress = id!((ev,ch,key,vel) =>
 ...
 * \param val control value
 */
alias snd_seq_ev_set_controller = id!((ev,ch,cc,val) =>
 ...
 */
alias snd_seq_ev_set_pgmchange = id!((ev,ch,val) =>
 ...
 */
alias snd_seq_ev_set_pitchbend = id!((ev,ch,val) =>
 ...
 */
alias snd_seq_ev_set_chanpress = id!((ev,ch,val) =>
 ...
 */
alias snd_seq_ev_set_sysex = id!((ev,datalen,dataptr) =>
