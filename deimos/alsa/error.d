...
enum SND_ERROR_BEGIN =            500000          /**< Lower boundary of sound error codes. */;
enum SND_ERROR_INCOMPATIBLE_VERSION =     (SND_ERROR_BEGIN+0) /**< Kernel/library protocols are not compatible. */;
enum SND_ERROR_ALISP_NIL =        (SND_ERROR_BEGIN+1) /**< Lisp encountered an error during acall. */;
 ...
 */
alias void function(const(char)* file, int line, const(char)* function_, int err, const(char)* fmt, ...) snd_lib_error_handler_t/* __attribute__ ((format (printf, 5, 6))) */;
extern __gshared snd_lib_error_handler_t snd_lib_error;
extern __gshared int snd_lib_error_set_handler(snd_lib_error_handler_t handler);
...
alias void function(const(char)* file, int line,
                      const(char)* func, int err,
                      const(char)* fmt, va_list arg) snd_local_error_handler_t;
