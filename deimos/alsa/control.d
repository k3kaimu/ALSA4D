...
struct snd_ctl_elem_id_t;

/** CTL element identifier list container */
struct snd_ctl_elem_list_t;

/** CTL element info container */
struct snd_ctl_elem_info_t;

/** CTL element value container */
struct snd_ctl_elem_value_t;

/** CTL event container */
struct snd_ctl_event_t;
...
enum SND_CTL_NAME_IEC958(string expl, string direction, string what) = "IEC958 " ~ expl
                                                                     ~ mixin(`SND_CTL_NAME_` ~ direction)
                                                                     ~ mixin(`SND_CTL_NAME_IEC958_` ~ what);
...
int snd_ctl_elem_tlv_read(snd_ctl_t *ctl, const snd_ctl_elem_id_t *id,
              uint *tlv, uint tlv_size);
int snd_ctl_elem_tlv_write(snd_ctl_t *ctl, const snd_ctl_elem_id_t *id,
               const uint *tlv);
int snd_ctl_elem_tlv_command(snd_ctl_t *ctl, const snd_ctl_elem_id_t *id,
                 const uint *tlv);
static if(isVersion!"__ALSA_HWDEP_H"){
int snd_ctl_hwdep_next_device(snd_ctl_t *ctl, int * device);
int snd_ctl_hwdep_info(snd_ctl_t *ctl, snd_hwdep_info_t * info);
}
static if(isVersion!"__ALSA_PCM_H"){
int snd_ctl_pcm_next_device(snd_ctl_t *ctl, int *device);
int snd_ctl_pcm_info(snd_ctl_t *ctl, snd_pcm_info_t * info);
int snd_ctl_pcm_prefer_subdevice(snd_ctl_t *ctl, int subdev);
}
static if(isVersion!"__ALSA_RAWMIDI_H"){
...
ptrdiff_t snd_ctl_elem_info_get_min(const snd_ctl_elem_info_t *obj);
ptrdiff_t snd_ctl_elem_info_get_max(const snd_ctl_elem_info_t *obj);
ptrdiff_t snd_ctl_elem_info_get_step(const snd_ctl_elem_info_t *obj);
...
int snd_ctl_elem_add_integer(snd_ctl_t *ctl, const snd_ctl_elem_id_t *id, uint count, ptrdiff_t imin, ptrdiff_t imax, ptrdiff_t istep);
...
ptrdiff_t snd_ctl_elem_value_get_integer(const snd_ctl_elem_value_t *obj, uint idx);
...
void snd_ctl_elem_value_set_boolean(snd_ctl_elem_value_t *obj, uint idx, ptrdiff_t val);
void snd_ctl_elem_value_set_integer(snd_ctl_elem_value_t *obj, uint idx, ptrdiff_t val);
...
int snd_tlv_parse_dB_info(uint *tlv, uint tlv_size,
              uint **db_tlvp);
int snd_tlv_get_dB_range(uint *tlv, ptrdiff_t rangemin, ptrdiff_t rangemax,
             ptrdiff_t *min, ptrdiff_t *max);
int snd_tlv_convert_to_dB(uint *tlv, ptrdiff_t rangemin, ptrdiff_t rangemax,
              ptrdiff_t volume, ptrdiff_t *db_gain);
int snd_tlv_convert_from_dB(uint *tlv, ptrdiff_t rangemin, ptrdiff_t rangemax,
                ptrdiff_t db_gain, ptrdiff_t *value, int xdir);
 ...
 */
alias int function(const snd_hctl_elem_t *e1,
                  const snd_hctl_elem_t *e2) snd_hctl_compare_t;
 ...
 */
alias int function(snd_hctl_t *hctl,
                   uint mask,
                   snd_hctl_elem_t *elem) snd_hctl_callback_t;
/** 
 ...
 * \return 0 on success otherwise a negative error code
 */
alias int function(snd_hctl_elem_t *elem,
                    uint mask) snd_hctl_elem_callback_t;
